...
// Function to get the total number of business customers
function getTotal_B_Customers($conn) {
    $sql = "SELECT COUNT(*) AS total_b_customers 
    FROM bcustomers
    WHERE MONTH(arrival) = MONTH(CURRENT_DATE()) 
    AND YEAR(arrival) = YEAR(CURRENT_DATE())";
...
function getTotal_W_Customers($conn) {
    $sql = "SELECT COUNT(*) AS total_w_customers
            FROM w_customers
...
<div class="container-fluid px-4">
    <h1 class="mt-3">Front Office Dashboard (Current Month)</h1>        
    <?php alertMessage(); ?>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card text-white mb-4" style="background-color: #8785E9FF; position: relative;">
                ...
                <div class="card-body">
                    ...
                    <center><h3><?php echo $total_b_Customers; ?></h3></center>                    
                </div>           
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card text-white mb-4" style="background-color: #64D881FF; position: relative;">
                <div style="position: absolute; top: 10px; right: 8px;">
                    ...
                    <i id="fallbackIcon2" class="fas fa-user" style="display: none; color: #11B33AFF; font-size: 70px;"></i>
                </div>        
                <div class="card-body">
                    <h5>Walk-In Guests</h5>            
                    <center><h3><?php echo $total_w_Customers; ?></h3></center>                    
                </div>           
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card text-white mb-4" style="background-color: #8AD9E7FF; position: relative;">
                <div style="position: absolute; top: 8px; right: 8px;">
                    ...
                    <i id="fallbackIcon3" class="fas fa-shopping-cart" style="display: none; color: #21B5CFFF; font-size: 80px;"></i>
                </div>        
                <div class="card-body">
                    <h5>Orders</h5>            
...
<div class="container-fluid px-3">
    <div class="card mt-2 shadow-sm">
        ...
        <div class="card-body px-3 mt-3">
            ...
            ?>
                <div id="table-scroll" class="table-responsive overflow-auto" style="max-height: 150px;">
