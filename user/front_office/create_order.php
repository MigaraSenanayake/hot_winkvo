                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="order_item_delete.php?index=<?= $key; ?>" class="btn btn-outline-danger btn-sm">Remove</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
           ...
           <div class="row">
                <div class="col-md-6 mb-2 ">
                    ...
                    <select name="cusId" id="cusId" class="form-select js-mySelect2">
                        ...
                        <?php                            
                            $name = mysqli_query($conn, "SELECT * FROM w_customers");
                            if ($name && mysqli_num_rows($name) > 0) {
                                foreach ($name as $cusData) {
                                    echo '<option value="'.$cusData['id'].'">'.$cusData['nic_pp'].'  -  '.$cusData['title'].' '.$cusData['name'].'</option>';
                                }
                            } else {
