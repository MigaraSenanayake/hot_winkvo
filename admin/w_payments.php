...
<div class="container-fluid px-3">
    <div class="card mt-2 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Payments (Walk-In)
        ...
        <div class="card-body px-3 mt-3"> <!-- Corrected class name -->
            ...
            <?php
            $payments = getAllWithCondition('w_payments', "status = 'Success'");
...
<script>
    ...
    printWindow.document.write(`
        <html>
            <head>
                <title>Print Payments Table (Walk-In)</title>
                <style>
                    table {
                        width: 100%;
