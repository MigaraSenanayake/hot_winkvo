...
<div class="container-fluid px-3">
    <div class="card mt-2 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Verify Order Payments (Walk-In)
        ...
        <div class="card-body">
            ...
            <form method="POST" action="w_update_status.php"> <!-- Form wrapping both tables -->                        
            <div class="row">
